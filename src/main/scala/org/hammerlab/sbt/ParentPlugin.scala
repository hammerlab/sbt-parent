  ...
  override def projectSettings: Seq[_root_.sbt.Def.Setting[_]] = {
    ...
    val versionSettings =
      Seq(
        ...
        libs := {
          Map(
            'adam_core -> "org.hammerlab.adam" %% "core" % "0.21.2",
            ...
            'genomic_utils -> "org.hammerlab.genomics" %% "utils" % "1.2.1",
            ...
            'loci -> "org.hammerlab.genomics" %% "loci" % "1.5.3",
            ...
            'reads -> "org.hammerlab.genomics" %% "reads" % "1.0.3",
            'readsets -> "org.hammerlab.genomics" %% "readsets" % "1.0.4",
            'reference -> "org.hammerlab.genomics" %% "reference" % "1.2.2",
