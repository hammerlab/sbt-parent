      ...
      Seq(
        ...
        libs := {
          Map(
            ...
            'magic_rdds -> "org.hammerlab" %% "magic-rdds" % "1.4.2-SNAPSHOT",
            ...
            'spark_tests -> "org.hammerlab" %% "spark-tests" % "1.3.6-SNAPSHOT",
            ...
            'test_utils -> "org.hammerlab" %% "test-utils" % "1.2.3-SNAPSHOT"
          )
        }
      )
