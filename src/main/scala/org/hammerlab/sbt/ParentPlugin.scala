  ...
  override def projectSettings: Seq[_root_.sbt.Def.Setting[_]] = {
    ...
    val versionSettings =
      Seq(
        ...
        libs := {
          Map(
            'adam_core -> "org.hammerlab.adam" %% "core" % "0.21.3-SNAPSHOT",
            ...
            'genomic_utils -> "org.hammerlab.genomics" %% "utils" % "1.2.2-SNAPSHOT",
            ...
            'loci -> "org.hammerlab.genomics" %% "loci" % "1.5.4-SNAPSHOT",
            ...
            'reference -> "org.hammerlab.genomics" %% "reference" % "1.2.3-SNAPSHOT",
