...
[![org.hammerlab.sbt:assembly](https://img.shields.io/badge/org.hammerlab.sbt:assembly-4.6.3-green.svg)](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.hammerlab.sbt%22%20a%3A%22assembly%22)

Plugin providing shading / executable-JAR configs

```scala
addSbtPlugin("org.hammerlab.sbt" % "assembly" % "4.6.3")
```
